...
- Choice outcome text is optional. Leaving it blank omits `text` from the outcome and moves directly to the connected node without showing an outcome narration.
